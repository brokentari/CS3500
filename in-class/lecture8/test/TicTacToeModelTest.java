...
public class TicTacToeModelTest {
  ...
  public void testFullBoardWithWinner() {
    ttt1.move(0, 0); // Place X upper left
    ttt1.move(0, 1); // Place O upper middle
    ttt1.move(1, 0); // Place X middle left
    ttt1.move(1, 1); // Place O center
    ttt1.move(2, 1); // Place X lower middle
    ttt1.move(0, 2); // Place O upper right
    ttt1.move(1, 2); // Place X middle right
    ttt1.move(2, 2); // Place O lower right
    ttt1.move(2, 0); // Place X lower left
