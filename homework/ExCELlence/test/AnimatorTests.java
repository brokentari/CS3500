...
import cs3500.excellence.hw05.model.ExcellenceAnimatorImpl;
...
public class AnimatorTests {
  ...
  public void testValidResize() {
    ...
    assertEquals("motion  R  1  200  200  50  100  0  0  0\t|\t20  200  200  25  100  0  0  0\n",
        animator.toString());
  }
  ...
  public void testGetShapePosition() {
    ...
    ModelPosition testModelPosition = animator.getShapePosition("R", 1);
  ...
  public void testAssignmentSampleOutput() {
    ...
    assertEquals("motion  R  1  200  200  50  100  0  0  0\t|\t10  200  200  50  100  0  0  0\n"
            ...
            + "motion  R  51  300  300  50  100  0  0  0\t|\t70  300  300  25  100  0  0  0\n"
            + "motion  R  70  300  300  25  100  0  0  0\t|\t100  200  200  25  100  0  0  0\n"
